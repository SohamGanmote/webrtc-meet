    ...
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="h-screen grid grid-cols-1 md:grid-cols-2">
        ...
        */}
        ...
        {/* Local Video */}
        <div className="fixed sm:relative overflow-hidden bg-gray-50 border rounded-md sm:rounded-none sm:h-screen sm:w-full h-52 w-36 right-4 top-4 sm:right-0 sm:top-0">
          <video
            ref={localVideoRef}
            autoPlay
            playsInline
      ...
      {/* Room Code */}
      <div className="fixed bottom-[110px] left-1/2 transform -translate-x-1/2 z-10 text-sm cursor-pointer">
